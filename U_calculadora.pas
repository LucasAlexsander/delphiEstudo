...
type
  TForm1 = class(TForm)
    ...
    procedure bnt_cClick(Sender: TObject);
  private
...
procedure TForm1.bnt_cClick(Sender: TObject);
begin
...
if lb_operador.Text = '.' then
  begin
    lb_campo1.Text := lb_campo1.Text  + '8';
  end
  else
  begin
    lb_campo2.Text := lb_campo2.Text + '8';
  end;
end;
...
if lb_operador.Text = '.' then
  begin
    lb_campo1.Text := lb_campo1.Text  + '9';
  end
  else
  begin
    lb_campo2.Text := lb_campo2.Text + '9';
  end;
end;
...
begin
  if lb_operador.Text = '.' then
  begin
    lb_campo1.Text := lb_campo1.Text  + ',';
  end
  else
  begin
    lb_campo2.Text := lb_campo2.Text + ',';
  end;
end;
